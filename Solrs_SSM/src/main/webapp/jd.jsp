...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/resource/base.css" media="all">
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/resource/plist20131112.css" media="all">
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/resource/list-page-20141009.css" media="all">
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/resource/pop_compare.css" media="all">
    <link rel="shortcut icon" type="image/ico"
          href="${pageContext.request.contextPath}/http://list.jd.com/favicon.ico">
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/resource/jquery-1.2.6.pack.js"></script>
...
<div id="o-header-2013">
    <div class="w" id="header-2013">
        <div id="logo-2013" class="ld"><a href="http://www.jd.com/" hidefocus="true"><b></b><img src="resource/logo-201305.png" width="270" height="60" alt="京东"></a></div>
        <!--logo end-->
        <div id="search-2013">
            <div class="i-search ld">
                <ul id="shelper" class="hide"></ul>

                <form id="actionForm" action="get" method="GET">
                    <div class="form">
                    ...
                    <input type="hidden" name="priceStr" id="price" value="${priceStr}"/>
        ...
        <div id="filter">
            ...
            <div class="fore1">
                ...
                <div class="pagin pagin-m">
                    <span class="text"><i>当前${pageList.currPage}页</i>/共${pageList.countPage}</span>
                    <a href="javascript:changePage(-1)" class="prev">上一页<b></b></a>
                    <a href="javascript:changePage(1)" class="next">下一页<b></b></a>
                </div>
                <div class="total">
			<span>共<strong>${pageList.count}</strong>个商品
			</span>
                </div>
                <span class="clr"></span>
            </div>
                        ...
                        <div class="lh-wrap">
                            <div class="p-img">
                                <a target="_blank" href="#">
                                    <img width="220" height="282" class="err-product" src="${pageContext.request.contextPath}/images/${p.picture}">
                                </a>
                            </div>
                            <div class="p-name">
                                <a target="_blank" href="#">${p.pname }</a>
                            </div>
                            <div class="p-price">
                                <strong>￥${p.price}</strong><span id="p1269191543"></span>
                            </div>
                        </div>
                    </li>
                </c:forEach>
