...
<link rel="stylesheet" type="text/css"
	href="resource/base.css" media="all">
<link rel="stylesheet" type="text/css"
	href="resource/plist20131112.css" media="all">
<link rel="stylesheet" type="text/css"
	href="resource/list-page-20141009.css" media="all">
<link rel="stylesheet" type="text/css"
	href="resource/pop_compare.css" media="all">
	...
	<div class="w" id="header-2013">
		...
		<div id="search-2013">
			...
			<form id="actionForm" action="product/get" method="get">
				...
				<input type="hidden" name="catalogName" id="catalog_name" value="${catalog_name }"/>
				<input type="hidden" name="priceStr" id="price" value="${price}"/>
				<input type="hidden" name="currtPage" id="page" value="${curPage }"/>
				<input type="hidden" name="psort" id="sort" value="${sort }"/>
			</form>
			</div>
			<div id="hotwords"></div>
		</div>
			...
			<div class="lh-wrap">
				<div class="p-img">
					<a target="_blank" href="#">
						<img width="220" height="282" class="err-product" src="images/${p.picture}">
					</a>
				</div>
				<div class="p-name">
				...
				<div class="p-price">
					<strong>￥<fmt:formatNumber value="${p.price}" maxFractionDigits="2"/></strong><span id="p1269191543"></span>
				</div>
			</div>
		</li>
		</c:forEach>
